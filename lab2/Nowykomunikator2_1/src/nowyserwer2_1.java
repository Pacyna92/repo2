...
public class nowyserwer2_1 implements Runnable {
    private ServerSocket serwer;
    
    public nowyserwer2_1(int port_) {
        try {
    ...
    public void run() {
        ...
        while (true) {
            try {
                ...
                komponent_nowegoklienta2_1 komp_klienta =
                        new komponent_nowegoklienta2_1(gniazdo_klienta, wejscie, wyjscie);
    ...
    public static void main(String args[]) throws Exception {
        int Port = 15000;
        nowyserwer2_1 s2 = new nowyserwer2_1(Port);
